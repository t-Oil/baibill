...
export class OrganizationController {
    ...
    async create(
        ...
        try {
            ...
            const response = await this.organizationService.create(
                body.name,
                userId,
                body.description,
            );
    ...
    async update(
        ...
        try {
            const response = await this.organizationService.update(
                uid,
                body.name,
                body.description,
            );
    ...
    async removeMember(
        ...
        try {
            ...
            await this.organizationService.removeMember(org.id, parseInt(userId, 10));
