    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] px-4 transition-colors duration-200">
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-[var(--muted)]">Start managing your receipts today</p>
        </div>
            ...
            <>
              ...
              <div className="mt-6">
                ...
                <div className="mt-4 text-center">
                  <Link
                    href="/login"
                    className="font-medium text-[var(--button-primary)] hover:text-[var(--button-hover)] transition-colors"
                  >
                    Sign in here
                  </Link>
                </div>
