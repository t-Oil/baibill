  ...
  const features = [
    {
      ...
      description:
        'Automatically extract text from receipt images using advanced AI models. Supports multiple currencies and formats.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description:
        'Real-time statistics and insights. Track spending trends, average receipt amounts, and more.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description:
        'Manage multiple organizations with role-based access. Perfect for teams and businesses.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Privacy First',
      description:
        'Self-hosted solution. Your data stays on your servers. No third-party data sharing.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description:
        'JWT authentication, password encryption, CORS protection, and comprehensive security headers.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description:
        'Docker Compose setup included. Deploy to any server in minutes with comprehensive documentation.',
    },
  ];
  ...
  const useCases = [
    {
      ...
      description:
        'Track expenses, manage receipts, and generate reports for accounting and tax purposes.',
      icon: '🏢',
    },
    {
      title: 'Accountants',
    ...
    <div className="min-h-screen bg-[var(--bg)]">
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              <svg
                className="w-8 h-8 text-[var(--button-primary)]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-[var(--muted)] mb-8 max-w-3xl mx-auto">
            A modern, self-hosted receipt management system with powerful OCR capabilities. Extract
            data from receipts automatically, track expenses, and gain insights into your spending.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[var(--muted)] max-w-2xl mx-auto">
            Built for businesses and individuals who value their data privacy and need powerful
            receipt management
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-[var(--muted)] mb-4">
                Modern, self-hosted receipt management system with powerful OCR capabilities. Open
                source and privacy-first.
              </p>
              <p className="text-sm text-[var(--muted)]">© 2026 Receipt OCR. MIT License.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    href="/login"
                    className="text-[var(--muted)] hover:text-[var(--button-primary)] transition-colors"
                  >
                    Features
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a
                    href="https://github.com/yourusername/receipt-ocr/issues"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[var(--muted)] hover:text-[var(--button-primary)] transition-colors"
                  >
